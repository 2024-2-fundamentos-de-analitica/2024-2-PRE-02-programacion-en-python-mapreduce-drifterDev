...
def run_job(input_directory, output_directory):
    """Job"""
    sequences = load_input(input_directory)
    sequences = line_preprocessing(sequences)
    sequences = mapper(sequences)
    sequences = shuffle_and_sort(sequences)
    sequences = reducer(sequences)
    create_ouptput_directory(output_directory)
    save_output(output_directory, sequences)
